...
class ServerModel:
    ...
    def run(self, inputs):
        ...
        self.logger.info("""Using model #%d\t%d inputs
               \ttranslation time: %f""" % (self.model_id, len(texts_to_translate),
    ...
    @staticmethod
    def extract_features(sound, sample_rate, truncate, window_size, window_stride, window, normalize_audio):
