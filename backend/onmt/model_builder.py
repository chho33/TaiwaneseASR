...
def build_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    if model_opt.model_type == "text":
        ...
        if model_opt.encoder_type == "transformer":
            ...
            encoder = AudioEncoder(model_opt.rnn_type,
                                   ...
                                   model_opt.brnn,
                                   model_opt.input_size,
                                   model_opt.enc_rnn_size,
                                   model_opt.dec_rnn_size,
                                   model_opt.audio_enc_pooling,
                                   model_opt.dropout,
                                   model_opt.ctc_ratio,
                                   len(fields[ctc_vocab_field].vocab),
                                   model_opt.sample_rate,
                                   model_opt.window_size,
                                   model_opt.ctc_out_layer)
    ...
    if model_opt.ctc_ratio < 1:
        ...
        model = onmt.models.CTCModel(encoder)
    ...
    if checkpoint is not None:
        ...
        if model_opt.ctc_ratio < 1 and hasattr(model.decoder, 'embeddings'):
